...
## Como fazer o teste
Se você possuir uma conta no Github, faça um fork deste repositório, desenvolva seu código e por fim realize um pull request e aguarde pelo feedback. Caso não possua uma conta Github ou conhecimento com Git, poderá nos enviar a pasta do projeto compactada através do email vagas@ideia2001.com.br com o assunto "DEVMOBIDEIA". Enviar também currículo atualizado. Favor se identificar ao enviar o pull request.
